...
async function main() {
  ...
  await bot.api.setMyCommands([
    ...
    { command: 'activity', description: 'Live activity snapshot' },
    ...
    { command: 'notify', description: 'Watch tasks for completion alerts' },
    { command: 'newsletter', description: 'Newsletter management' },
    { command: 'approve', description: 'Worker approvals & HITL' },
    { command: 'file', description: 'File manager (reports, logs, notes)' },
    { command: 'apps', description: 'Launch Mini Apps' },
    ...
    { command: 'topicid', description: 'Show current topic thread ID' },
