<#
.SYNOPSIS
    Onboard an external project into Projects/ with diamond workflow scaffolding.
...
.PARAMETER Name
    Project name (used as folder name under Projects/).
...
$ProjectsDir = Join-Path $OpaiRoot "Projects"
...
if (-not (Test-Path $Source)) {
    ...
    $queueId = Add-ToQueue -Type "project-onboard" `
        -Description "Move $Name from external location into Projects/$Name" `
        -Payload $payload `
